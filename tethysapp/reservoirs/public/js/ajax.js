...
function dataOverview() {
    $.ajax({
        url:'/apps/reservoirs/ajax/overviewpage/',
        data: 'get some infos',
        dataType: 'json',
...
function getHistoricalChart() {
    $.ajax({
        url:'/apps/reservoirs/ajax/reshistplot/',
...
function getStorageCapacity() {
    $.ajax({
        url:'/apps/reservoirs/ajax/resstorageplot/',
        data: 'please make me a chart',
        dataType: 'json',
        contentType: "application/json",
        method: 'POST',
...
function statisticalReport() {
    $.ajax({
        url:'/apps/reservoirs/ajax/reservoirstatistics/',
...
function simulationTable() {
    $.ajax({
        url:'/apps/reservoirs/ajax/simulationTable/',
        data: $("#reservoir").val(),
        dataType: 'json',
        contentType: "application/json",
        method: 'POST',
...
function performsimulation() {
    ...
    $.ajax({
        url:'/apps/reservoirs/ajax/performsimulation/',
...
function updatesheet() {
    $.ajax({
        url:'/apps/reservoirs/ajax/updatesheet/',
